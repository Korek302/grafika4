...
public class ProjectionPanelXZ extends JPanel 
{
	public ProjectionPanelXZ() 
	{
		super();
    ...
    protected void paintComponent(Graphics g) 
    {
    	for(Triangle t : MainPanel.triangleList)
    	{
    		...
    		pointList[0] = new Point(t.getV1().getX(), t.getV1().getZ());
    		pointList[1] = new Point(t.getV2().getX(), t.getV2().getZ());
    		pointList[2] = new Point(t.getV3().getX(), t.getV3().getZ());

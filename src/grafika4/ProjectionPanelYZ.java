...
public class ProjectionPanelYZ extends JPanel 
{
	public ProjectionPanelYZ() 
	{
		super();
    ...
    protected void paintComponent(Graphics g) 
    {
    	...
    	for(Triangle t : MainPanel.triangleList)
    	{
    		...
    		pointList[0] = new Point(t.getV1().getY() + centerizerX, this.getHeight() - t.getV1().getZ() - centerizerY);
    		pointList[1] = new Point(t.getV2().getY() + centerizerX, this.getHeight() - t.getV2().getZ() - centerizerY);
    		pointList[2] = new Point(t.getV3().getY() + centerizerX, this.getHeight() - t.getV3().getZ() - centerizerY);
